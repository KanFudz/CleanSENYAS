...
class LoadGameState(State):
    ...
    def render(self):
        ...
        if self.selected_profile_data:
            ...
            # In the render method, where you're drawing the progress section:
            ...
            content_area = pygame.Rect(
                ...
                content_start_y,
                self.data_panel.width,
                self.data_panel.height - (content_start_y - self.data_panel.y)
            )
            ...
            for i, line in enumerate(self.lines_to_draw):
                ...
                # Only draw if within the content area (this check is redundant with clipping but good practice)
