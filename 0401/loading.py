...
class OnScreenKeyboardState(State):
    def __init__(self, game, initial_text=''):
        ...
        self.font = pygame.font.Font("FONTS/ARIAL.ttf", 36) 
...
def show_loading_screen(screen, progress):
    ...
    try:
        developers_font = pygame.font.Font("fonts/Nunito-Regular.ttf", 18)  # Smaller font for "DEVELOPERS:"
        names_font = pygame.font.Font("fonts/Nunito-Bold.ttf", 24)  # Larger font for names
    except:
