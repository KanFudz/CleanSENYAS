...
class Game:
    def __init__(self):
        ...
        self.states = {
            ...
            "playing_home": HomeState(self, "home", None, "HOME.mp3"),
            "playing_galaxy": GalaxyExplorerState(self, "gexplorer", "playing_alphabets", "GALAXY.mp3"),  # Add appropriate audio file
            "playing_alphabets": GalaxyExplorerAlphabetState(self, "galpha", None, "GALPHASONG.mp3")  # Add appropriate audio file
}
