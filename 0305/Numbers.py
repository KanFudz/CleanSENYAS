...
class VideoWithSignInState(VideoState):
    def __init__(self, game, video_key, next_state=None, audio_file=None, next_button_collision_height=50):
        ...
        self.next_button_collision.height = 85
        self.next_button_collision.width = 280
        self.next_button_collision.x = 372
...
class GalaxyExplorerAlphabetState(VideoState):
    def __init__(self, game, video_key, next_state=None, audio_file=None):
        ...
        button_data = [
            ("GALPHAA.png", "playing_a"), ("GALPHAB.png", "playing_b"), ("GALPHAC.png", "playing_c"),
            ("GALPHAD.png", "playing_d"), ("GALPHAE.png", "playing_e"), ("GALPHAF.png", "playing_f"),
            ("GALPHAG.png", "playing_g"), ("GALPHAH.png", "playing_h"), ("GALPHAI.png", "playing_i"),
            ("GALPHAJ.png", "playing_j"), ("GALPHAK.png", "playing_k"), ("GALPHAL.png", "playing_l"),
            ("GALPHAM.png", "playing_m"), ("GALPHAN.png", "playing_n"), ("GALPHAO.png", "playing_o"),
            ("GALPHAP.png", "playing_p"), ("GALPHAQ.png", "playing_q"), ("GALPHAR.png", "playing_r"),
            ("GALPHAS.png", "playing_s"), ("GALPHAT.png", "playing_t"), ("GALPHAU.png", "playing_u"),
            ("GALPHAV.png", "playing_v"), ("GALPHAW.png", "playing_w"), ("GALPHAX.png", "playing_x"),
            ("GALPHAY.png", "playing_y"), ("GALPHAZ.png", "playing_z")
        ]
...
class GalaxyExplorerNumberState(VideoState):
    def __init__(self, game, video_key, next_state=None, audio_file=None):
        ...
        button_data = [
            ("2_Numbers/GNUM0.png", "playing_0"), ("2_Numbers/GNUM1.png", "playing_1"), ("2_Numbers/GNUM2.png", "playing_2"),
            ("2_Numbers/GNUM3.png", "playing_3"), ("2_Numbers/GNUM4.png", "playing_4"), ("2_Numbers/GNUM5.png", "playing_5"),
            ("2_Numbers/GNUM6.png", "playing_6"), ("2_Numbers/GNUM7.png", "playing_7"), ("2_Numbers/GNUM8.png", "playing_8"),
            ("2_Numbers/GNUM9.png", "playing_9")
        ]
    ...
    def __init__(self):
        ...
        self.states = {
            ...
            "playing_usertype": UserTypeState(self, "usertype", [
                ("LEARNER.png", None, "playing_learner_planet"),  # Changed to play BLGSIGN after LEARNER
                ("GUARDIAN.png", None, "playing_guardian_planet")
            ], "USERTYPE.mp3"),  
            "load_game": LoadGameState(self, "blgsign"),  # New load game state
            ...
            "playing_learner_landing": VideoState(self, "llanding", "playing_blgsign", "LLANDING.mp3"),  
             "playing_blgsign": BLGSignState(self, "blgsign", [
                ("NEW GAME.png", None, "playing_lgsign"),  # NEW GAME leads to LGSIGN
                ("LOAD GAME.png", None, "load_game")      # LOAD GAME leads to load game screen
            ]),
