...
class GalaxyExplorerAlphabetState(VideoState):
    ...
    def handle_event(self, event):
        if event.type == pygame.MOUSEMOTION:
            ...
            # Play hover sound if we have a new hovered button
            if hovered and hovered != self.hovered_button:
                pygame.mixer.Sound("BUTTONS/CURSOR ON TOP.mp3").play()
        ...
        if ret:
            ...
            if result.multi_hand_landmarks:
                for hand_landmarks in result.multi_hand_landmarks:
                    ...
                    # Draw landmarks
                    self.mp_drawing.draw_landmarks(webcam_frame, hand_landmarks, self.mp_hands.HAND_CONNECTIONS)
...
class Game:
    def __init__(self):
        ...
        self.states = {
            ...
            "playing_galaxy": GalaxyExplorerState(self, "gexplorer", None, "AUDIO/HOME.mp3"),
            "playing_alphabets": GalaxyExplorerAlphabetState(self, "galpha", None, "AUDIO/HOME.mp3"),
            "playing_numbers": GalaxyExplorerNumberState(self, "gnum", None, "AUDIO/HOME.mp3"),
